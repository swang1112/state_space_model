function Geweke_Z = geweke_diagnostic(draws)

% Based on codes from (Author: Rolando Gonzales)
% https://ww2.mathworks.cn/matlabcentral/fileexchange/54382-bayesian-spatial-propensity-score-matching-bs-psm?s_tid=FX_rc2_behav
...
% first 10% and last 40% 
frac_s1   = 0.1; 
frac_s2   = 0.5; 

% Compute Geweke's convergence diagnostics
results1   = momentg(draws(1:frac_s1*ndraws,:));
results2   = momentg(draws(1+(frac_s1+frac_s2)*ndraws:end,:));
